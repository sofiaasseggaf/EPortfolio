package com.project.studentportfolio;
...
import com.project.studentportfolio.model.sekolah.MsSekolah;
...
import com.project.studentportfolio.student.HomeStudent;
import com.project.studentportfolio.teacher.HomeTeacher;
            ...
            if (!txtUsername.getText().toString().isEmpty() && !txtPassword.getText().toString().isEmpty()) {
                try {
                    for (int i = 0; i < dataModelUser.getTotal(); i++) {
                        ...
                        password = dataModelUser.getData().getAauthUsers().get(i).getKeypass();
