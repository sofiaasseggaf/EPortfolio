...
public class GuruStudent extends AppCompatActivity {
        ...
        dataSiswax.enqueue(new Callback<ModelGuru>() {
            ...
            public void onFailure(Call<ModelGuru> call, Throwable t) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(GuruStudent.this, "Terjadi gangguan koneksi", Toast.LENGTH_LONG).show();
                    }
                });
                call.cancel();
            }
    ...
    public void onBackPressed() {
        Intent a = new Intent(GuruStudent.this, HomeStudent.class);
        startActivity(a);
        finish();
    }
}
