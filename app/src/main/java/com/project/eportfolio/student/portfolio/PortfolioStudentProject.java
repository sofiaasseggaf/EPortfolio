...
public class PortfolioStudentProject extends AppCompatActivity {
            ...
            public void onResponse(Call<ModelPortofolio> call, Response<ModelPortofolio> response) {
                ...
                if (response.body()!=null){
                    ...
                    if(listPortofolio==null){
                        Toast.makeText(PortfolioStudentProject.this, "Kamu Tidak Memiliki Portofolio Project", Toast.LENGTH_SHORT).show();

                    } else {
                        for(int i=0; i<listPortofolio.size(); i++){
                            try {
                                if (listPortofolio.get(i).getIdkategori().equalsIgnoreCase("2")){
                                    listProjectMurid.add(listPortofolio.get(i));
                                }
                    ...
                    if (listProjectMurid!=null){
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                findViewById(R.id.framelayout).setVisibility(View.GONE);
                                Toast.makeText(PortfolioStudentProject.this, "Tidak Memiliki Project", Toast.LENGTH_SHORT).show();
